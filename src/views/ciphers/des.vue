    ...
    methods: {
        encryptDES(){
            if (this.textString !== '' && this.passStr !== ''){
                this.encString = this.CryptoJS.DES.encrypt(this.textString, this.passStr);
        ...
        decryptDES(){
            if (this.textStringDecrypt !== '' && this.passStrDecrypt !== ''){
                this.decString = this.CryptoJS.DES.decrypt(this.textStringDecrypt, this.passStrDecrypt).toString(this.CryptoJS.enc.Utf8);
...
<template>
    <p class="text-2xl mb-3">DES Encryption</p>
    <input
        v-model="passStr"
        type="text"
    ...
    <p v-show="showEncStr" class="mb-2 text-black dark:text-white text-lg">DES encrypted string:</p>
    ...
    <p class="text-2xl mt-9 mb-3">DES Decryption</p>
    <input
    ...
    <p v-show="showDecStr" class="mb-2 text-black dark:text-white text-lg">DES decrypted string:</p>
