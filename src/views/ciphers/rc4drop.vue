    ...
    methods: {
        encryptRC4(){
            if (this.textString !== '' && this.passStr !== ''){
                this.encString = this.CryptoJS.RC4Drop.encrypt(this.textString, this.passStr);
        ...
        decryptRC4(){
            if (this.textStringDecrypt !== '' && this.passStrDecrypt !== ''){
                let encData = this.CryptoJS.RC4Drop.decrypt(this.textStringDecrypt, this.passStrDecrypt);
...
<template>
    <p class="text-2xl mb-3">RC4Drop Encryption</p>
    <input
        v-model="passStr"
        type="text"
    ...
    <p v-show="showEncStr" class="mb-2 text-black dark:text-white text-lg">RC4Drop encrypted string:</p>
    ...
    <p class="text-2xl mt-9 mb-3">RC4Drop Decryption</p>
    <input
    ...
    <p v-show="showDecStr" class="mb-2 text-black dark:text-white text-lg">RC4Drop decrypted string:</p>
