...
export default {
    ...
    methods: {
        generateHash(){
            if(this.hmacStr === ''){
                if (this.textString !== ''){
                    this.hashString = this.CryptoJS.MD5(this.textString);
                    this.showHash = true;
                } else {
                    this.showHash = false;
                }
                ...
                if (this.textString !== ''){
                    this.hashString = this.CryptoJS.HmacMD5(this.textString, this.hmacStr);
                    this.showHash = true;
                } else {
                    this.showHash = false;
                }
...
<template>
    <p class="text-2xl mb-3">MD5 hash generator</p>
    <input
        v-model="hmacStr"
        type="text"
    ...
    <p v-show="showHash" class="mb-2 text-black dark:text-white text-lg">MD5 hash:</p>
